...
public class Config {
    ...
    private static final ModConfigSpec.BooleanValue AllOn = BUILDER
            .push("All_On")
    ...
    /*************************************/
    private static final ModConfigSpec.BooleanValue EasyMode = BUILDER
            .push("EasyMode")
    ...
    /*************************************/
    private static final ModConfigSpec.ConfigValue<String> Interval_Textis = BUILDER
            .pop(2)
            .push("Interval_1")
    ...
    private static final ModConfigSpec.ConfigValue<String> Color_Interval_String_1_ = BUILDER
            .comment("\n" + "符号'/'的颜色。" +
                    "\nThe color of the symbol '/'." +
                    "\n默认值(Default)：\"#5A5A5A\"")
            .define("Color_Interval_String_1", "#5A5A5A");
    private static final ModConfigSpec.ConfigValue<String> Interval__Text1 = BUILDER
            .pop(1)
            .push("Interval_2")
    ...
    /* 感觉完全没必要...
private static final ModConfigSpec.ConfigValue<String> Prefix_Health1 = BUILDER
...
private static final ModConfigSpec.ConfigValue<String> Prefix_Food1 = BUILDER
    .comment("\n" + "定义饱食度的前缀，如：‘蛋糕:’16+5" +
            "\n\"A prefix that defines the amount of Food, e.g. 'Food:'16+5" +
            "\n默认值(Default)：Prefix_String=\"\"")
    .define("Prefix_String", "");
*/
    private static final ModConfigSpec.ConfigValue<String> Color_Interval_String_2_ = BUILDER
            .comment("\n" + "符号'+'的颜色。" +
                    "\nThe color of the symbol '+'." +
                    "\n默认值(Default)：\"#F6E58D\"")
            .define("Color_Interval_String_2", "#F6E58D");
    /*************************************/
    private static final ModConfigSpec.BooleanValue supersaturation_On1 = BUILDER
            .pop(1)
    ...
    private static final ModConfigSpec.BooleanValue Bloodsucker_On1 = BUILDER
            .pop(1)
    ...
    private static final ModConfigSpec.ConfigValue<String> Color_Vampires_Blood1 = BUILDER
            .comment("\n" + "吸血鬼血量文本颜色。" +
                    "\nVampires Blood value text color." +
                    "\n默认值(Default)：\"#AC2019\"")
            .define("Color_Vampires_Blood", "#AC2019");
    private static final ModConfigSpec.ConfigValue<String> Color_Vampires_MaxBlood1 = BUILDER
            .comment("\n" + "吸血鬼最大血量文本颜色。" +
                    "\nVampires Max Blood value text color." +
                    "\n默认值(Default)：\"#600000\"")
            .define("Color_Vampires_MaxBlood", "#600000");
    private static final ModConfigSpec.BooleanValue Thirst_On1 = BUILDER
            .pop(1)
            .push("Thirst")
    ...
    private static final ModConfigSpec.ConfigValue<String> Color_Thirst1 = BUILDER
            .comment("\n" + "水分值文本颜色。" +
                    "\nThirst Value text color." +
                    "\n默认值(Default)：\"#0048AD\"")
            .define("Color_Thirst", "#0048AD");
    private static final ModConfigSpec.ConfigValue<String> Color_Thirst_Quenched1 = BUILDER
            .comment("\n" + "止渴水分值文本颜色。" +
                    "\nThirst Quenched value text color." +
                    "\n默认值(Default)：\"#82DAFD\"")
            .define("Color_Thirst_Quenched", "#82DAFD");
    private static final ModConfigSpec.BooleanValue Origins_On1 = BUILDER
            .pop(1)
            .push("Origins")
    ...
    private static final ModConfigSpec.ConfigValue<String> Color_Origins1 = BUILDER
            .comment("\n" + "起源能力文本颜色。" +
                    "\nOrigins Power value text color." +
                    "\n默认值(Default)：\"#EBE994\"")
            .define("Color_Origins", "#EBE994");
    private static final ModConfigSpec.ConfigValue<String> Color_Origins_Symbol1 = BUILDER
            .comment("\n" + "符号'%'文本颜色。" +
                    "\nSymbol value text color." +
                    "\n默认值(Default)：\"#D2DAA4\"")
            .define("Color_Origins_Symbol", "#D2DAA4");
    private static final ModConfigSpec.BooleanValue Artifact_On1 = BUILDER
            .pop(1)
            .push("Artifacts")
    ...
    private static final ModConfigSpec.ConfigValue<String> Color_Artifacts1 = BUILDER
            .comment("\n" + "火烈鸟饰品飞行时间文本颜色。" +
                    "\nFlamingo ornament flight time text color." +
                    "\n默认值(Default)：\"#BE3D6F\"")
            .define("Color_Artifacts", "#BE3D6F");
    private static final ModConfigSpec.ConfigValue<String> Color_Artifacts_Symbol1 = BUILDER
            .comment("\n" + "符号'%'文本颜色。" +
                    "\nSymbol value text color." +
                    "\n默认值(Default)：\"#DC6788\"")
            .define("Color_Artifacts_Symbol", "#DC6788");
    /*************************************/
    private static final ModConfigSpec.BooleanValue Food_On1 = BUILDER
            .pop(2)
    ...
    private static final ModConfigSpec.IntValue MaxFood_On1 = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue Food_ExhaustionLevel_On1 = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue Armor_Toughness_On1 = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue Air_On1 = BUILDER
    ...
    private static final ModConfigSpec.BooleanValue Mounts_On1 = BUILDER
    ...
    /*************************************/
    private static final ModConfigSpec.BooleanValue Health_On1 = BUILDER
            .pop(1)
    ...
    private static final ModConfigSpec.BooleanValue Armour_On1 = BUILDER
            .comment("\n" + "如果设置为false,将关闭盔甲值的显示。 " +
                    "\nIf set to false, the display of armor values is turned off" +
                    "\n默认值(Default)：true")
            .define("Armour-functional-status", true);
    /*************************************/
    private static final ModConfigSpec.ConfigValue<String> Color_Health1 = BUILDER
            .pop(2)
            .push("Color")
            .comment("血量值文本颜色。" +
    ...
    private static final ModConfigSpec.ConfigValue<String> Color_Health_Absorb1 = BUILDER
            .comment("\n" + "伤害吸收文本颜色。" +
                    "\nHealth Absorb value text color." +
                    "\n默认值(Default)：\"#BAB363\"")
            .define("Color_Health_Absorb", "#BAB363");
    private static final ModConfigSpec.ConfigValue<String> Color_Health_Tail1 = BUILDER
            .comment("\n" + "最大血量文本颜色。" +
                    "\nMax Health value text color." +
                    "\n默认值(Default)：\"#FF1313\"")
            .define("Color_Health_Tail", "#FF1313");
    private static final ModConfigSpec.ConfigValue<String> Color_Food1 = BUILDER
            .comment("\n" + "饱食度文本颜色。" +
                    "\nFood value text color." +
                    "\n默认值(Default)：\"#C6C677\"")
            .define("Color_Food", "#C6C677");
    private static final ModConfigSpec.ConfigValue<String> Color_Food_Saturation1 = BUILDER
            .comment("\n" + "饱和度文本颜色。" +
                    "\nSaturation value text color." +
                    "\n默认值(Default)：\"#C1805D\"")
            .define("Color_Food_Saturation", "#C1805D");
    private static final ModConfigSpec.ConfigValue<String> Color_Food_Tail1 = BUILDER
            .comment("\n" + "最大饱食度文本颜色。" +
                    "\nMax Food value text color." +
                    "\n默认值(Default)：\"#DFB18F\"")
            .define("Color_Food_Tail", "#DFB18F");
    private static final ModConfigSpec.ConfigValue<String> Color_Armor1 = BUILDER
            .comment("\n" + "盔甲文本颜色。" +
                    "\nArmor value text color." +
                    "\n默认值(Default)：\"#DDEBEB\"")
            .define("Color_Armor", "#DDEBEB");
    private static final ModConfigSpec.ConfigValue<String> Color_Armor_Toughness1 = BUILDER
            .comment("\n" + "盔甲韧性文本颜色。" +
                    "\nArmor Toughness value text color." +
                    "\n默认值(Default)：\"#BDECFC\"")
            .define("Color_Armor_Toughness", "#BDECFC");
    private static final ModConfigSpec.ConfigValue<String> Color_Air1 = BUILDER
            .comment("\n" + "氧气文本颜色。" +
                    "\nAir value text color." +
                    "\n默认值(Default)：\"#0094FF\"")
            .define("Color_Air", "#0094FF");
    private static final ModConfigSpec.ConfigValue<String> Color_Air_Symbol1 = BUILDER
            .comment("\n" + "氧气符号'%'文本颜色。" +
                    "\nAir Symbol value text color." +
                    "\n默认值(Default)：\"#D1EBFF\"")
            .define("Color_Air_Symbol", "#D1EBFF");

    private static final ModConfigSpec.ConfigValue<String> Color_Food_ExhaustionLevel1 = BUILDER
            .comment("\n" + "食物消耗进度（疲劳值）的文本颜色。" +
    ...
    public static boolean supersaturation_On, Food_ExhaustionLevel_On, Thirst_On, Artifacts_On, Origins_On, All_On, Bloodsucker_On, Food_On, Health_On, EasyMode_Text_On, Armour_On, Armor_Toughness_On, Air_On, Mounts_On;
